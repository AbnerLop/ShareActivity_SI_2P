...
A01332362
Red Neuronal para predecir el precio de una casa según sus características.
...
'''
columns = ['bedrooms','bathrooms','floors','grade','condition']
target = ['price']
...
xtrain y ytrain: 
    ...
    Por lo que el total de datos (21613) se multiplicó por 0.8 y se ingreso este valor
    más uno (17291 + 1). Esto último debido a que la primer fila contiene el nombre de las columnas
xtest y ytest:
